...
const Category = (props) => {
  ...
  return (
    <div
      className="  w-96 h-32 bg-white flex flex-row items-center m-6 md:w-80 md:h-96 md:flex-col duration-200 md:hover:scale-110  "
      style={{
        boxShadow:
          " rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px",
      }}
    >
      <div className=" w-1/3 h-2/3 md:w-full flex justify-center">
